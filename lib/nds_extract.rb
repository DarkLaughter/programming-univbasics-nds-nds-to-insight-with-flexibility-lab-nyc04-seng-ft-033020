...
def movies_with_director_key(name, movies_collection)
  ...
  while counter < movies_collection.size do
    movie = movies_collection[counter]
    movie_hash << movie_with_director_name(name, movie)
    counter +=1
  end
...
def gross_per_studio(collection)
  ...
  while counter < collection.size do
    ...
    if !studios_gross[movie[:studio]]
      studios_gross[movie[:studio]] = movie[:worldwide_gross]
    else
      studios_gross[movie[:studio]] += movie[:worldwide_gross]
    end
